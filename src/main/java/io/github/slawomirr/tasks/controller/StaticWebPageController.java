...
public class StaticWebPageController {
    ...
    public String index(Map<String, Object> model) {
        model.put("swagger_info", "https://tasks-app-slawomirr-github.herokuapp.com/swagger-ui.html");
        model.put("swagger_link", "https://tasks-app-slawomirr-github.herokuapp.com/swagger-ui.html");
